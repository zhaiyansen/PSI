...
void PSIOperations::generateGarbledBloom(const std::vector<mpz_class>& input) {
...
void PSIOperations::generateAllGBFs() {
    auto start = std::chrono::high_resolution_clock::now();
    
    for (int i = 0; i < 3; ++i) {
        generateGarbledBloom(data[i]);
